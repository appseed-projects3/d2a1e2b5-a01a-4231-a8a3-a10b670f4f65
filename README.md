...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-04 02:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d2a1e2b5-a01a-4231-a8a3-a10b670f4f65.git
$ cd d2a1e2b5-a01a-4231-a8a3-a10b670f4f65
```
